...
band_data <- read.csv("data/HSR_0827_HMNBandingData_2022.csv", 
                      na.strings = c("",NA))
...
# csv created with this code at the end of script 
...
all_bands <- read.csv("data/updated_raw_2022.csv",
                      na.strings = c("",NA))
...
# the output name  
write.csv(band_data,"output/vetted_HSR_0827_2022.csv", row.names = FALSE)
